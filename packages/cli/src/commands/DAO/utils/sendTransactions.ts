...
const sleep = (ttl: number) => new Promise((resolve) => setTimeout(() => resolve(true), ttl));

export type WalletSigner = Pick<Wallet, 'publicKey' | 'signTransaction' | 'signAllTransactions'>;
