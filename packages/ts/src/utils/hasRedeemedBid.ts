...
import { BidRedemptionTicket,   MetaplexProgram,
...
export const getBidRedemptionTicket = async (connection: Connection,   auction: PublicKey, bidder: PublicKey, ) => {
...
export const hasRedeemedBid = (
  ticket: BidRedemptionTicket,
  order: number
) => {
